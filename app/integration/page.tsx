...
<script>
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const botMessage = {
        role: "assistant",
        content: `Echo: ${inputMessage}`, // Make it clear this is an echo
      };
                ...
                <Tabs defaultValue="code" className="w-full">
                  ...
                  <TabsContent value="code" className="space-y-4">
                    <p className="text-sm text-muted-foreground">
                      Copy and paste this code into the &lt;head&gt; section of
                      your website:
                    </p>
          ...
          <div className="flex-1 overflow-auto p-6">
            ...
            >
              <nav className="flex justify-between items-center">
                <div className="font-bold md:text-xl text-sm text-primary">
                  Company Name
                </div>
            ...
            >
              ...
              >
                A chatbot is a computer program that simulates conversation with human end users. It often uses NLP to parse inputs and generative AI to automate responses.
              </motion.p>
              ...
              >
                <motion.div variants={slideIn} className="space-y-4">
                  ...
                  Chatbots can provide 24/7 customer service and eliminate long wait times 
                  </p>
                </motion.div>
                <motion.div variants={slideIn} className="space-y-4">
                  ...
                  <p className="text-muted-foreground sm:text-base">
                    ...
                    conversation and are used for customer service, marketing,
                    and more. They can be used on websites, apps, or messaging
                    platforms
                  </p>
                </motion.div>
              </motion.div>
            ...
            <DialogContent className="sm:max-w-md">
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Your chatbot is now ready to use. What would you like to do
                  next?
                </p>
          ...
          <Dialog open={true} onOpenChange={() => setIntegrationStatus("idle")}>
            <DialogContent className="sm:max-w-md">
              ...
              >
                ...
                <p className="text-muted-foreground">
                  We couldn't detect the integration on your website. Please
                  make sure you've:
                </p>
